...
export const useUserNotifications = () => {
  ...
  const notifyUserCreated = useCallback(async (userName: string, branchId?: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyUserUpdated = useCallback(async (userName: string, branchId?: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyUserDeleted = useCallback(async (userName: string, branchId?: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyRoleChanged = useCallback(async (userName: string, branchId?: string) => {
    if (!currentUser?.uid) return;
...
export const useSystemNotifications = () => {
  ...
  const notifyMaintenance = useCallback(async (title: string, message: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyUpdate = useCallback(async (title: string, message: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifySecurity = useCallback(async (title: string, message: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyBackup = useCallback(async (title: string, message: string) => {
    if (!currentUser?.uid) return;
...
export const useEmailNotifications = () => {
  ...
  const notifyEmailSent = useCallback(async (recipient: string, subject: string, branchId?: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyEmailFailed = useCallback(async (recipient: string, subject: string, branchId?: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyEmailDelivered = useCallback(async (recipient: string, subject: string, branchId?: string) => {
    if (!currentUser?.uid) return;
  ...
  const notifyEmailBounced = useCallback(async (recipient: string, subject: string, branchId?: string) => {
    if (!currentUser?.uid) return;
