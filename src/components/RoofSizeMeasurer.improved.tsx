    ...
    try {
      ...
      canvases.forEach(canvas => {
        try {
          ...
          // ignore cross-origin drawing errors for tiles we can't access
      ...
      for (const svg of Array.from(svgs)) {
        try {
          ...
          // Inline external styles by copying computed styles where necessary would be ideal,
          // but for our case the SVG shapes inherit basic styles.
      ...
      markerEls.forEach(el => {
        try {
          ...
          // Draw a small circle where the marker is positioned
          ctx.beginPath();
        ...
        <div className='p-3 sm:p-4 border-t border-gray-200 bg-gray-50'>
          <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 sm:mb-4 gap-3'>
            ...
            {area !== null && (
              <div className='text-left sm:text-right w-full sm:w-auto'>
                ...
                <div className='text-xl sm:text-2xl font-bold text-[#7DA8CC]'>
                  {area.toFixed(2)} m²
                </div>
          ...
          <div className='flex gap-2 sm:gap-3'>
            ...
            <button
              ...
              className='flex-1 px-4 sm:px-6 py-3 bg-[#7DA8CC] text-white rounded-lg hover:bg-[#6890b3] active:bg-[#476279] transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base touch-manipulation'
              style={{ minHeight: '44px' }}
            >
