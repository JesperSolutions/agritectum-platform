...
const OfferDetail: React.FC<OfferDetailProps> = ({ offer, onSendReminder, onExtendValidity, onSendOffer, onExportOffer }) => {
          ...
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-red-600 text-sm">
                This offer has been pending for {daysPending} days. Consider following up with the customer.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-4">
              Set a new expiration date for this offer.
            </p>
            <input
              type="date"
              value={newValidUntil}
