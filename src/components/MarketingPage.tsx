...
const MarketingPage: React.FC = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10'>
          ...
          >
            ...
            <p className='text-lg text-gray-500 mb-12 max-w-3xl mx-auto'>
              Reduce inspection time by 40%, increase offer acceptance by 25%, and ensure GDPR
              compliance across all Nordic markets.
            </p>
      ...
      <section ref={el => (sectionRefs.current[1] = el)} className='py-20 bg-white'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Traditional roof inspection management creates bottlenecks, inconsistencies, and
              compliance risks. Here's how we solve it.
            </p>
          </div>
              ...
              <div className='space-y-6'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Paper calendars, phone calls, and missed appointments create scheduling
                      nightmares.
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Different formats, missing data, and delayed delivery frustrate customers.
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Offers get lost in email chains, leading to lost revenue and frustrated
                      customers.
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      GDPR violations, data breaches, and audit failures create legal and financial
                      exposure.
                    </p>
                  </div>
                </div>
              ...
              <div className='space-y-6'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Multi-branch calendar management with automated reminders and GPS routing.
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    <h4 className='font-semibold text-gray-900 mb-2'>
                      Mobile-Optimised Inspections
                    </h4>
                    <p className='text-gray-600'>
                      Offline-capable interface with photo uploads, templates, and auto-sync.
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Instant offer generation with follow-up workflows and approval tracking.
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Built-in compliance with data encryption, audit trails, and privacy controls.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section ref={el => (sectionRefs.current[2] = el)} className='py-20 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold text-gray-900 mb-6'>Complete Workflow Management</h2>
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                ...
                <div className='w-1/2 pr-8 text-right'>
                  <div className='bg-green-50 p-8 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-300'>
                    ...
                    <p className='text-gray-600 mb-4'>
                      Core platform features deployed and operational across multiple Nordic
                      branches. All essential workflows are functional with real-time data
                      synchronization.
                    </p>
                    ...
                    <p className='text-sm text-gray-500'>
                      <strong>Status:</strong> Live in production • <strong>Users:</strong> 50+
                      active • <strong>Uptime:</strong> 99.9%
                    </p>
                  </div>
                </div>
      ...
      <section ref={el => (sectionRefs.current[4] = el)} className='py-20 bg-white'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold text-gray-900 mb-6'>ESG Compliance & Security</h2>
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Built for Nordic compliance standards with enterprise-grade security and environmental
              responsibility
            </p>
          </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Three-tier permission system with granular controls
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
              ...
              <div className='space-y-4'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Monitor and report environmental impact of operations
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Track sustainable material usage and recycling
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Automated safety protocol tracking and reporting
                    </p>
                  </div>
                </div>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Built for Nordic environmental and safety standards
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <div className='bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-3xl shadow-lg transform hover:scale-105 transition-all duration-300'>
              <div className='text-center mb-6'>
                ...
                <h3 className='text-2xl font-bold text-gray-900'>
                  {t('marketing.userRoles.superadmin.title') || 'Superadmin'}
                </h3>
                <p className='text-sm text-gray-600'>
                  {t('marketing.userRoles.superadmin.permissionLevel') || 'Permission Level 2'}
                </p>
              </div>
            ...
            <div className='bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-3xl shadow-lg transform hover:scale-105 transition-all duration-300'>
              <div className='text-center mb-6'>
                ...
                <h3 className='text-2xl font-bold text-gray-900'>
                  {t('marketing.userRoles.branchAdmin.title') || 'Branch Admin'}
                </h3>
                <p className='text-sm text-gray-600'>
                  {t('marketing.userRoles.branchAdmin.permissionLevel') || 'Permission Level 1'}
                </p>
              </div>
              <div className='space-y-3'>
                <div className='flex items-center'>
      ...
      <section ref={el => (sectionRefs.current[6] = el)} className='py-20 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-16'>
            ...
            <div className='bg-white p-8 rounded-2xl shadow-lg'>
              ...
              <blockquote className='text-gray-700 italic'>
                "Taklaget transformed our inspection process. What used to take 3 hours now takes 90
                minutes. Our customers love the professional reports and faster turnaround."
              </blockquote>
            ...
            <div className='bg-white p-8 rounded-2xl shadow-lg'>
              ...
              <blockquote className='text-gray-700 italic'>
                "The offline capability is a game-changer. Our inspectors can work anywhere, and
                everything syncs automatically. No more lost data or delayed reports."
              </blockquote>
      ...
      >
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-5xl font-bold text-gray-900 mb-6'>Built with Modern Technology</h2>
