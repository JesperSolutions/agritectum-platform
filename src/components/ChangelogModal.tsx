        ...
        <div className='prose prose-sm max-w-none'>
          ...
          <div className='mb-8'>
            ...
            <div className='mb-4'>
              ...
              <ul className='list-disc list-inside space-y-1 text-slate-700 ml-4'>
                ...
                <li>
                  <strong>Service Agreement Purpose Field:</strong> Added textarea for agreement
                  purpose/description
                </li>
                <li>
                  <strong>Service Visits Checkboxes:</strong> 1 annual service visit option, 2
                  annual service visits option
                </li>
                <li>
                  <strong>Standard Services Checkboxes</strong> (10 services): Visual inspection,
                  roofing control, penetrations control, flashing control, drain cleaning, gutter
                  cleaning, debris removal, drainage test, walkway control, photo documentation
                </li>
                <li>
                  <strong>Optional Addons with Expandable Sections:</strong>
                  <ul className='list-disc list-inside ml-6 mt-1 space-y-1'>
                    <li>
                      <strong>Skylights & Fall Protection:</strong> Cleaning/inspection, annual
                      inspection (EN 365), safety equipment control
                    </li>
                    <li>
                      <strong>Solar Panels:</strong> Solar panel cleaning (1-2 times annually)
                    </li>
                    <li>
                      <strong>Steel Roofs:</strong> Moss/lichen removal, chemical roof treatment
                    </li>
                    <li>
                      <strong>Sedum Roofs (Green Roofs):</strong> Fertilization, weed control, sedum
                      repair, substrate refill, watering
                    </li>
                  </ul>
                </li>
                <li>
                  <strong>Pricing Structure Options:</strong> Per roof annual pricing with checkbox,
                  per square meter pricing with checkbox
                </li>
                <li>
                  <strong>Billing Frequency Selection:</strong> Annual or semi-annual options
                </li>
                <li>
                  <strong>Signature Fields:</strong> Supplier and customer signature fields
                </li>
                <li>
                  <strong>Service Report Information Section:</strong> Displays what's included in
                  service reports
                </li>
                <li>
                  <strong>Agreement Period Information:</strong> Notes about 12-month automatic
                  renewal
                </li>
              </ul>
            </div>
            ...
            <div className='mb-4'>
              ...
              <ul className='list-disc list-inside space-y-1 text-slate-700 ml-4'>
                <li>
                  Expanded ServiceAgreement TypeScript interface with new fields: purpose,
                  serviceVisits, standardServices, addons, pricingStructure, billingFrequency,
                  signatures
                </li>
                <li>Enhanced form state management to handle all new checkbox and field types</li>
                <li>
                  Updated form submission to include all new fields when creating/updating service
                  agreements
                </li>
                <li>
                  Added comprehensive translations for all new form fields in Danish, Swedish, and
                  German
                </li>
              </ul>
            </div>
            ...
            <div className='mb-4'>
              ...
              <ul className='list-disc list-inside space-y-1 text-slate-700 ml-4'>
                ...
                <li>
                  Added expandable/collapsible sections for addon categories using
          ...
          <div className='mb-8 border-t border-slate-200 pt-6'>
            ...
            <div className='mb-4'>
              ...
              <ul className='list-disc list-inside space-y-1 text-slate-700 ml-4'>
                <li>
                  Fixed missing translation keys in dashboard for Swedish, Danish, and German
                  locales
                </li>
                <li>
                  Improved language auto-detection to re-detect locale on each visit for
                  auto-detected locales
                </li>
                <li>
                  Fixed language not automatically switching for users in different regions (e.g.,
                  Denmark)
                </li>
                <li>Added distinction between manual and auto-detected locale preferences</li>
                <li>
                  Fixed console errors related to Firestore permission-denied queries for branch
                  service
                </li>
                <li>
                  Added client-side fallback for service agreement queries when Firestore index is
                  missing
                </li>
              </ul>
            </div>
            ...
            <div className='mb-4'>
              ...
              <ul className='list-disc list-inside space-y-1 text-slate-700 ml-4'>
                <li>
                  Enhanced locale detection system to preserve manual language selections while
                  allowing auto-detection updates
                </li>
                <li>
                  Improved branch service to query only accessible branches based on user
                  permissions
                </li>
              </ul>
            </div>
