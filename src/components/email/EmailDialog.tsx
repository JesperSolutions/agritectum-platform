      ...
      <div className='bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto'>
        ...
        <div className='flex items-center justify-between p-6 border-t border-gray-200'>
          <button
            ...
            className='inline-flex items-center px-4 py-2 text-slate-700 bg-slate-200 rounded-lg hover:bg-slate-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm font-medium shadow-sm'
          >
          ...
          <div className='flex items-center space-x-3'>
            ...
            <button
              ...
              className='inline-flex items-center gap-2 px-4 py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-800 transition-colors text-sm font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed'
            >
              {isSending ? (
                <>
