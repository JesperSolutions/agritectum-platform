                ...
                <div>
                  ...
                  <div className='relative'>
                    ...
                    <input
                      ...
                      className='block w-full pl-12 pr-12 py-3 border-b-2 border-gray-300 bg-gray-50 focus:bg-white focus:border-[#7DA8CC] focus:outline-none transition-all duration-material font-light'
