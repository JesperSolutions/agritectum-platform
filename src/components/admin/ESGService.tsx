            ...
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                ...
                <p className="text-emerald-50 text-lg mt-1">
                  {t('admin.esgService.subtitle') || 'Create ESG reports with intelligent roof allocation'}
                </p>
              </div>
            </div>
          </div>
          ...
          {selectedCustomer && (
            <div className="mt-4 flex items-center space-x-3 p-4 bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl border border-slate-200">
              ...
              <div>
                ...
                {selectedCustomer.email && <span className="text-sm text-slate-600 ml-2">({selectedCustomer.email})</span>}
              </div>
            </div>
          )}
        </div>
                ...
                <div className="max-h-80 overflow-y-auto space-y-2 rounded-xl">
                  {filteredBuildings.length === 0 ? (
                    <div className="p-8 text-center">
                      ...
                      <p className="text-slate-500">{t('admin.esgService.noBuildings') || 'No buildings found'}</p>
                    </div>
                  ) : (
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200/50 overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl p-5 border border-slate-200">
              <label htmlFor="roofSize" className="block text-sm font-bold text-slate-800 mb-3 flex items-center">
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-slate-600 to-slate-700 rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-white">{divisions.greenRoof}%</span>
                    </div>
                    <input
                      type="range"
                      min="0"
                      ...
                      onChange={(e) => handleDivisionChange('greenRoof', Number(e.target.value))}
                    ...
                    <p className="text-xs text-white/80 mt-3 leading-relaxed">
                      CO₂ absorption, stormwater retention, improved insulation, and biodiversity support
                    </p>
                  </div>
                </div>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-slate-500 to-slate-600 rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-white">{divisions.noxReduction}%</span>
                    </div>
                    <input
                      type="range"
                      min="0"
                      ...
                      onChange={(e) => handleDivisionChange('noxReduction', Number(e.target.value))}
                      className="w-full h-2 bg-white/30 rounded-lg appearance-none cursor-pointer"
                      style={{
                        WebkitAppearance: 'none',
                        appearance: 'none',
                    ...
                    />
                    <p className="text-xs text-white/80 mt-3 leading-relaxed">
                      Photocatalytic coatings break down NOₓ pollutants, improving air quality and reducing smog
                    </p>
                  </div>
                </div>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-white">{divisions.coolRoof}%</span>
                    </div>
                    <input
                      type="range"
                      min="0"
                    ...
                    />
                    <p className="text-xs text-white/80 mt-3 leading-relaxed">
                      Reflective surfaces reduce cooling costs by up to 50%, ideal for solar panel installation
                    </p>
                  </div>
                </div>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-slate-500 to-slate-600 rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-white">{divisions.socialActivities}%</span>
                    </div>
                    <input
                      type="range"
                      min="0"
                      ...
                      onChange={(e) => handleDivisionChange('socialActivities', Number(e.target.value))}
                      className="w-full h-2 bg-white/30 rounded-lg appearance-none cursor-pointer"
                      style={{
                        WebkitAppearance: 'none',
                        appearance: 'none',
                    ...
                    />
                    <p className="text-xs text-white/80 mt-3 leading-relaxed">
                      Community gardens, gathering spaces, and urban farming promote social well-being
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-5 text-center hover:shadow-lg transition-all">
                    ...
                    <p className="text-3xl font-bold text-green-600 mb-1">
                      {calculatedMetrics.co2ReductionKgPerYear ? Math.round(calculatedMetrics.co2ReductionKgPerYear) : '0'}
                    </p>
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-5 text-center hover:shadow-lg transition-all">
                    ...
                    <p className="text-3xl font-bold text-blue-600 mb-1">
                      {calculatedMetrics.energySavingsKwhPerYear ? Math.round(calculatedMetrics.energySavingsKwhPerYear) : '0'}
                    </p>
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-5 text-center hover:shadow-lg transition-all">
                    ...
                    <p className="text-3xl font-bold text-emerald-600 mb-1">
                      {calculatedMetrics.co2ReductionKgPerYear ? Math.round(calculatedMetrics.co2ReductionKgPerYear / 22) : '0'}
                    </p>
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-5 text-center hover:shadow-lg transition-all">
                    ...
                    <p className="text-3xl font-bold text-cyan-600 mb-1">
                      {calculatedMetrics.waterManagementLitersPerYear ? Math.round(calculatedMetrics.waterManagementLitersPerYear) : '0'}
                    </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-4 border border-slate-200">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600">
                              {divisions.greenRoof}% ({roofSize ? Math.round((parseFloat(roofSize) * divisions.greenRoof) / 100) : 0} m²)
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="grid grid-cols-3 gap-3 mt-3 text-center text-sm">
                        <div>
                          <p className="font-bold text-slate-900">{roofSize ? Math.round((parseFloat(roofSize) / 1000) * 525 * (divisions.greenRoof / 100)) : 0}</p>
                          <p className="text-xs text-slate-600">kg CO₂/year</p>
                        </div>
                        <div>
                          <p className="font-bold text-slate-900">{roofSize ? Math.round((parseFloat(roofSize) / 1000) * 375 * (divisions.greenRoof / 100)) : 0}</p>
                    ...
                    <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-4 border border-slate-200">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600">
                              {divisions.noxReduction}% ({roofSize ? Math.round((parseFloat(roofSize) * divisions.noxReduction) / 100) : 0} m²)
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="grid grid-cols-3 gap-3 mt-3 text-center text-sm">
                        <div>
                          <p className="font-bold text-slate-900">{roofSize ? Math.round((parseFloat(roofSize) / 1000) * 485 * (divisions.noxReduction / 100)) : 0}</p>
                          <p className="text-xs text-slate-600">kg CO₂/year</p>
                        </div>
                        <div>
                    ...
                    <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-4 border border-slate-200">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600">
                              {divisions.coolRoof}% ({roofSize ? Math.round((parseFloat(roofSize) * divisions.coolRoof) / 100) : 0} m²)
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="grid grid-cols-3 gap-3 mt-3 text-center text-sm">
                        <div>
                          <p className="font-bold text-slate-900">{roofSize ? Math.round((parseFloat(roofSize) / 1000) * 1663 * (divisions.coolRoof / 100)) : 0}</p>
                          <p className="text-xs text-slate-600">kg CO₂/year</p>
                        </div>
                        <div>
                          <p className="font-bold text-slate-900">{roofSize ? Math.round((parseFloat(roofSize) / 1000) * 2125 * (divisions.coolRoof / 100)) : 0}</p>
                          <p className="text-xs text-slate-600">kWh/year</p>
                        </div>
                        <div>
                    ...
                    <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-4 border border-slate-200">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h5 className="font-semibold text-slate-900">Social Activities Area</h5>
                            <p className="text-sm text-slate-600">
                              {divisions.socialActivities}% ({roofSize ? Math.round((parseFloat(roofSize) * divisions.socialActivities) / 100) : 0} m²)
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="grid grid-cols-3 gap-3 mt-3 text-center text-sm">
                        <div>
                          <p className="font-bold text-slate-900">{roofSize ? Math.round((parseFloat(roofSize) / 1000) * 125 * (divisions.socialActivities / 100)) : 0}</p>
                          <p className="text-xs text-slate-600">kg CO₂/year</p>
                        </div>
                        <div>
                          <p className="font-bold text-slate-900">0</p>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        CO₂ absorption per year ≈ {calculatedMetrics.co2ReductionKgPerYear ? Math.round(calculatedMetrics.co2ReductionKgPerYear) : 0} kg CO₂/year
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-xs text-slate-600 mt-1">Savings + generation per year</p>
                    </div>
                    <div className="text-center">
                      <p className="text-4xl font-bold text-cyan-600 mb-2">
                        💨 {calculatedMetrics.waterManagementLitersPerYear ? Math.round(calculatedMetrics.waterManagementLitersPerYear / 100) : 0}
                      </p>
                    ...
                    <div className="relative">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-4xl font-black text-white">
                          {calculatedMetrics.co2ReductionKgPerYear ? calculatedMetrics.co2ReductionKgPerYear.toFixed(1) : '0.0'}
                        </div>
                  ...
                  <div className="group relative overflow-hidden bg-gradient-to-br from-slate-500 to-slate-600 rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div className="relative">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-4xl font-black text-white">
                          {calculatedMetrics.energySavingsKwhPerYear ? calculatedMetrics.energySavingsKwhPerYear.toFixed(1) : '0.0'}
                        </div>
                  ...
                  <div className="group relative overflow-hidden bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div className="relative">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-4xl font-black text-white">
                          {calculatedMetrics.waterManagementLitersPerYear ? calculatedMetrics.waterManagementLitersPerYear.toFixed(1) : '0.0'}
                        </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">Share this link with your customer</p>
                </div>
                <button
