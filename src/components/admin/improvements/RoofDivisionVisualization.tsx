          ...
          return (
            ...
            >
              <div className="flex items-center space-x-3">
                <div
                  className={`w-4 h-4 rounded ${improvementColors[improvement.type]}`}
                />
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        ...
        {totalPercentage > 100 && (
          <p className="text-xs text-red-600 mt-1">
            {t('admin.improvements.overAllocated') ||
              'Warning: Total exceeds 100%'}
          </p>
        )}
        {totalPercentage < 100 && remainingPercentage > 5 && (
          <p className="text-xs text-gray-500 mt-1">
            {t('admin.improvements.underAllocated') ||
              'You can allocate more area to improvements'}
          </p>
        )}
      </div>
    </div>
