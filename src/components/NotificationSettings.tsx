      ...
      <div className='bg-white rounded-xl shadow-sm border border-slate-200 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto'>
        ...
        <div className='flex items-center justify-between p-6 border-b border-slate-200'>
          <div className='flex items-center space-x-2'>
            ...
            <h2 className='text-xl font-bold text-slate-900'>{t('notifications.settings')}</h2>
          </div>
          <button
            onClick={onClose}
                  ...
                  <div className='flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-200'>
                    ...
                    <label className='relative inline-flex items-center cursor-pointer'>
                      <input
                        type='checkbox'
                        checked={
                          preferences.preferences.inspectionComplete ||
                          preferences.preferences.urgentIssues
                        }
