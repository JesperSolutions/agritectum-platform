    ...
    <div className='space-y-6'>
      ...
      >
        <button
          ...
          className='flex items-center gap-2 px-4 py-2 bg-white text-slate-900 rounded-lg hover:bg-slate-50 transition-colors text-sm font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed'
        >
              ...
              <div className='bg-[#A1BA53]/10 rounded-lg p-4'>
                ...
                {formData.hasGreenRoof && (
                  <div className='grid grid-cols-3 gap-3 mt-3'>
                    <div>
                      <label className='block text-sm font-medium text-gray-700 mb-1'>
                        {t('buildings.greenRoofArea') || 'Area (m²)'}
                      </label>
                      <input
                        type='number'
