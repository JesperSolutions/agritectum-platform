          ...
          <div className='text-center'>
            ...
            <div className='mt-6 space-y-3'>
              ...
              <button
                ...
                className='w-full flex justify-center items-center px-4 py-2 border border-slate-300 rounded-lg shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors'
              >
            ...
            {process.env.NODE_ENV === 'development' && (
              <details className='mt-6 text-left'>
                ...
                <pre className='mt-2 text-xs text-slate-400 bg-slate-100 p-2 rounded overflow-auto'>
